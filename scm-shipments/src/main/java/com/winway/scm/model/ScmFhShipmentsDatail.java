...
public class ScmFhShipmentsDatail extends BaseModel<String>{
	...
	public String toString() {
		...
		.append("id", this.id) 
		.append("shipmentsTaskId", this.shipmentsTaskId) 
		.append("type", this.type) 
		.append("taskType", this.taskType) 
		.append("dateCode", this.dateCode) 
		.append("shipmentsAffirmDate", this.shipmentsAffirmDate) 
		...
		.append("deliveringAmount", this.deliveringAmount) 
		.append("warehouse", this.warehouse) 
		.append("stock", this.stock) 
		.append("contactPersion", this.contactPersion) 
		.append("phone", this.phone) 
		.append("shippingAddress", this.shippingAddress) 
		.append("dateOfManufacture", this.dateOfManufacture) 
