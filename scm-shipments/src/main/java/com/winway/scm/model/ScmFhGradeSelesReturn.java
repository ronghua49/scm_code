...
public class ScmFhGradeSelesReturn extends BaseModel<String> {
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id).append("masterId", this.masterId)
				.append("directiveCode", this.directiveCode).append("productName", this.productName)
				.append("productCode", this.productCode).append("aChange", this.aChange)
				.append("productState", this.productState).append("productSum", this.productSum)
				.append("price", this.price).append("priceSum", this.priceSum).append("batchNumber", this.batchNumber)
				.append("actualDeliveryDate", this.actualDeliveryDate).append("returnMessage", this.returnMessage)
				.append("memo", this.memo).append("shipmentsId", this.shipmentsId).toString();
	}
}