...
<div>
    ...
    <transition name="el-fade-in">
      <div class="content-item" v-show="showDetailsPage === '2'">
        <bis-agree-approve-details :key="forceRefresh" v-on:closedetailspage="closedetailspage" :passparam="passIdJSON"></bis-agree-approve-details>
      </div>
    </transition>
...
import BisAgreeNameApproveDetails from "./BisAgreeNameApproveDetails"; // 引入协议签订组件
export default {
    name: "businessCreditApprove",
    components: {
    "bis-agree-approve-details": BisAgreeNameApproveDetails
  },
    data () {
        return {
