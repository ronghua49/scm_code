...
<div>
    ...
    <transition name="el-fade-in">
      <div class="content-item" v-show="showDetailsPage === '2'">
        <business-accept-approve-details :key="forceRefresh" v-on:closedetailspage="closedetailspage" :passparam="passIdJSON"></business-accept-approve-details>
      </div>
    </transition>
...
import BusinessAcceptApproveDetails from "./BusinessAcceptApproveDetails"; // 引入协议签订组件
export default {
    name: "businessCreditApprove",
    components: {
    "business-accept-approve-details": BusinessAcceptApproveDetails
  },
    data () {
        return {
