    ...
    <div>
        ...
        <transition name="el-fade-in">
            <div v-show='isShowPage' :key="refresh">
                <big-contract-apply :pageState="pageState" @closeapplypage="closeapplypage" :isApproval="isApproval"
                                    :row="row">
...
<script>
    ...
    import xsBigContractApply from "../xsglManagement/EveryDayApply"

    export default {
        name: "EveryDayContractApproval",
        components: {
        ...
        methods: {
            ...
            approval(row) {
                ...
                this.pageState = 'everyDayApproval,' + row.procInstId;
                console.log(row);
