...
<div>
    ...
    <transition name="el-fade-in">
      <div class="content-item" v-show="showDetailsPage === '2'">
        <distributor-agreement-approve-details :key="forceRefresh" v-on:closedetailspage="closedetailspage" :passparam="passIdJSON"></distributor-agreement-approve-details>
      </div>
    </transition>
...
import DistributorAgreementApproveDetails from "./DistributorAgreementApproveDetails"; // 引入协议签订组件
export default {
    name: "businessCreditApprove",
    components: {
    "distributor-agreement-approve-details": DistributorAgreementApproveDetails
  },
    data () {
        return {
