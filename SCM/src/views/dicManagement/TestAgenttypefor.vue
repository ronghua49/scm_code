<template>
    ...
    <div>
      ...
      <xyj-table   :highlightCurrentRow="true" :stripe="true" :border="true" :total="pageResult.total"
        :data="pageResult" :columns="columns" :showBatchDelete="false" :pageRequset="pageRequest"
        @findPage="findPage"  @handleClickRow="pClickrow" @handleEdit="handleEdit"  @handleDelete="handleDelete">
      </xyj-table>
...
<script>
import XyjTable from "@/components/table/XyjTable";
export default {
  name: "agenttype",
  components: {
    "xyj-table": XyjTable
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { inlineTemplate: true, label: "操作", minWidth: 120, formatter:(row, column, cellValue, index)=>{
            return `
