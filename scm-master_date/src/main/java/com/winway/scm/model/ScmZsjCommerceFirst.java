...
public class ScmZsjCommerceFirst extends BaseModel<String> {
	...
	@ApiModelProperty(value = "商业编号(查询)")
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id).append("commerceId", this.commerceId)
				.append("ownerId", this.ownerId).append("approvalId", this.approvalId)
				.append("approvalState", this.approvalState).toString();
	}
}