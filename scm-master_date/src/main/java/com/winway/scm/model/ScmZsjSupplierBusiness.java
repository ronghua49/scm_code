 ...
 * </pre>
 */
 @ApiModel(value = "ScmZsjSupplierBusiness",description = "供应商营业执照信息") 
public class ScmZsjSupplierBusiness extends BaseModel<String>{
	...
	public String toString() {
		...
		.append("registerCode", this.registerCode) 
