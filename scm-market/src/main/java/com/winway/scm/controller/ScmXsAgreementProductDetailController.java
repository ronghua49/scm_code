...
public class ScmXsAgreementProductDetailController extends BaseController {
	...
	/**
	 * 协议品规明细列表(分页条件查询)数据 @param request
	 * 
	 * @return @throws Exception PageJson @exception
	 */
	@PostMapping("/list")
	@ApiOperation(value = "协议品规明细数据列表", httpMethod = "POST", notes = "获取协议品规明细列表")
	public PageList<ScmXsAgreementProductDetail> list(
	...
	public CommonResult<List<ScmXsAgreementProductDetail>> getAgreementProduct(
			...
			@ApiParam(name = "masterId", value = "主表ID", required = true) @PathVariable String masterId)
			throws Exception {
		List<ScmXsAgreementProductDetail> agreementProduct = scmXsAgreementProductDetailManager
				.getAgreementProduct(businessDivisionId, provinceId, ownerId, masterId);
		return new CommonResult<List<ScmXsAgreementProductDetail>>(true, "获取成功", agreementProduct);
	}

	@GetMapping(value = "/getNoImplement/{businessDivisionId}/{provinceId}/{ownerId}/{masterId}/{productId}")
	@ApiOperation(value = "中标选择否实施时返回数据", httpMethod = "GET", notes = "中标选择否实施时返回数据")
	public CommonResult<ScmXsAgreementProductDetail> getNoImplement(
			@ApiParam(name = "businessDivisionId", value = "商务分区ID", required = true) @PathVariable String businessDivisionId,
			@ApiParam(name = "provinceId", value = "省区ID", required = true) @PathVariable String provinceId,
			@ApiParam(name = "ownerId", value = "货主ID", required = true) @PathVariable String ownerId,
			@ApiParam(name = "masterId", value = "主表ID", required = true) @PathVariable String masterId,
			@ApiParam(name = "productId", value = "品规编码", required = true) @PathVariable String productId) {
		ScmXsAgreementProductDetail scmXsAgreementProductDetail = scmXsAgreementProductDetailManager
				.getProductDetailBycode(businessDivisionId, provinceId, ownerId, masterId, productId);
		return new CommonResult<ScmXsAgreementProductDetail>(true, "获取成功", scmXsAgreementProductDetail);
	}
	...
	public ScmXsAgreementProductDetail get(
			@ApiParam(name = "ID", value = "业务对象主键", required = true) @PathVariable String ID) throws Exception {
		return scmXsAgreementProductDetailManager.get(ID);
	}

	/**
	 * 新增协议品规明细 @param scmXsAgreementProductDetail @throws
	 * Exception @return @exception
	 */
	@PostMapping(value = "save")
	@ApiOperation(value = "新增,更新协议品规明细数据", httpMethod = "POST", notes = "新增,更新协议品规明细数据")
	public CommonResult<String> save(
			@ApiParam(name = "scmXsAgreementProductDetail", value = "协议品规明细业务对象", required = true) @RequestBody ScmXsAgreementProductDetail scmXsAgreementProductDetail)
			throws Exception {
	...
	/**
	 * 删除协议品规明细记录 @param id @throws Exception @return @exception
	 */
	...
	/**
	 * 批量删除协议品规明细记录 @param ids @throws Exception @return @exception
	 */
	...
	public CommonResult<List<ScmXsBigContractProductByUpdateVo>> listAgrProductByBigUpdate(
		...
		List<ScmXsBigContractProductByUpdateVo> listAgrProductByBigUpdate = scmXsAgreementProductDetailManager
				.listAgrProductByBigUpdate(id, agreementSummaryId);
