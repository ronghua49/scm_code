...
public class ScmXsBigContractProductSum extends BaseModel<String> {
	...
	@ApiModelProperty(value = "是否失效 1失效0有效")
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id).append("ownerId", this.ownerId)
				.append("commerceFirstId", this.commerceFirstId).append("productGauge", this.productGauge)
				.append("MedicineType", this.MedicineType).append("commonName", this.commonName)
				.append("suggestApplyNum", this.suggestApplyNum).append("lastShipmentDate", this.lastShipmentDate)
				.append("SMSCurrentMonthSales", this.SMSCurrentMonthSales).append("productCode", this.productCode)
				.append("isSMS", this.isSMS).append("theNumber", this.theNumber).append("packageNum", this.packageNum)
				.append("unitPrice", this.unitPrice).append("sumPrice", this.sumPrice)
				.append("surplusSUm", this.surplusSUm).toString();
	}
}