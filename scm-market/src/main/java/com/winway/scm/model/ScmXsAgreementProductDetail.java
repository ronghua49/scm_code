...
public class ScmXsAgreementProductDetail extends BaseModel<String>{
	...
	public String toString() {
		...
		.append("commerceGauge", this.commerceGauge) 
		.append("isSign", this.isSign) 
		.append("effectiveDate", this.effectiveDate) 
		.append("gaugeType", this.gaugeType) 
		.append("isBidding", this.isBidding) 
		.append("isImplement", this.isImplement) 
		.append("biddingPrice", this.biddingPrice) 
		.append("supplyPrice", this.supplyPrice) 
		.append("allotGross", this.allotGross) 
		.append("acceptGross", this.acceptGross) 
		.append("purePinGross", this.purePinGross) 
		.append("wireTransferPrice", this.wireTransferPrice) 
		.append("acceptPrice", this.acceptPrice) 
		.append("purePinPrice", this.purePinPrice) 
