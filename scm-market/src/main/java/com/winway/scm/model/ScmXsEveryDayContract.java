...
public class ScmXsEveryDayContract extends BaseModel<String> {
	...
	public static final String APPROVAL_OPPOSE_STATE = "3";
	...
	public void setScmXsEveryDayContractProductList(
			List<ScmXsEveryDayContractProduct> scmXsEveryDayContractProductList) {
