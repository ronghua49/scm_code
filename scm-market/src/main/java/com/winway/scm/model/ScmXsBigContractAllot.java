...
public class ScmXsBigContractAllot extends BaseModel<String>{
	...
	*/
	...
	public void setScmXsBigContractAllotProductList(List<ScmXsBigContractAllotProduct> scmXsBigContractAllotProductList) {
	...
	public String toString() {
		...
		.append("allocationCode", this.allocationCode) 
