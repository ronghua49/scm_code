 ...
 * </pre>
 */
 @ApiModel(value = "ScmProdAgencyScore",description = "商品代理制积分管理") 
public class ScmProdAgencyScore extends BaseModel<String>{
	...
	protected Double prodAgencyScore; 
	...
	public void setProdAgencyScore(Double prodAgencyScore) {
		this.prodAgencyScore = prodAgencyScore;
	}
	 ...
	 * @return
	 */
	public Double getProdAgencyScore() {
		return this.prodAgencyScore;
	}
	...
	public String toString() {
		...
		.append("prodAgencyScore", this.prodAgencyScore) 
