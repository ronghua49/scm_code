 ...
 * </pre>
 */
 @ApiModel(value = "ScmCwPaymentOrder",description = "付款采购订单表") 
public class ScmCwPaymentOrder extends BaseModel<String>{
	...
	@ApiModelProperty(value="采购订单订单号")
	protected String proOrderCode; 
	...
	protected String getMoneyWarehous; 
	...
	public void setProOrderCode(String proOrderCode) {
	...
	public void setGetMoneyWarehous(String getMoneyWarehous) {
		this.getMoneyWarehous = getMoneyWarehous;
	}
	 ...
	 * @return
	 */
	public String getGetMoneyWarehous() {
		return this.getMoneyWarehous;
	}
	/**
	...
	public String toString() {
		...
		.append("proOrderCode", this.proOrderCode) 
		...
		.append("getMoneyWarehous", this.getMoneyWarehous) 
		.toString();
	}
}